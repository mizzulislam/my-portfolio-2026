            ...
            <div className="pt-8 border-t border-white/5 space-y-4">
              <div className="flex gap-4">
                <button
                  ...
                  className={`flex-1 p-4 rounded-2xl flex items-center justify-center gap-2 border ${isDark ? "bg-white/5 border-white/10 text-yellow-400" : "bg-slate-50 border-slate-200 text-indigo-600"}`}
                >
                  {isDark ? <Sun size={20} /> : <Moon size={20} />}
                </button>
                <button
                  onClick={() => setLang(lang === "en" ? "id" : "en")}
                  className={`flex-1 p-4 rounded-2xl flex items-center justify-center gap-2 border ${isDark ? "bg-white/5 border-white/10 text-white" : "bg-slate-50 border-slate-200 text-slate-900"}`}
                >
                  <Languages size={20} />
                ...
                <button
                  onClick={toggleMusic}
                  className={`flex-1 p-4 rounded-2xl flex items-center justify-center gap-2 border ${isDark ? "bg-white/5 border-white/10 text-blue-400" : "bg-slate-50 border-slate-200 text-blue-600"}`}
                >
                  {isMusicPlaying ? (
                    <Volume2 size={20} />
                  ) : (
