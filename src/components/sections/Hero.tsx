            ...
            */}
            ...
            <div className="flex gap-3 sm:gap-4">
              ...
              <a
                ...
                className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl border flex items-center justify-center transition-colors shadow-sm ${isDark ? "border-white/10 hover:bg-white/5" : "border-slate-200 hover:bg-slate-100"}`}
              >
