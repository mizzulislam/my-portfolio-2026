...
export const translations = {
  en: {
    ...
    technicalTools: [
      { name: 'MS Word', logo: '/assets/tools/word.webp' },
      { name: 'MS Excel', logo: '/assets/tools/excel.webp' },
      { name: 'MS PowerPoint', logo: '/assets/tools/powerpoint.webp' },
      { name: 'SPSS', logo: '/assets/tools/spss.webp' },
      { name: 'Stata', logo: '/assets/tools/stata.webp' },
      { name: 'E-Views', logo: '/assets/tools/eviews.webp' },
      { name: 'G Suite', logo: '/assets/tools/gsuite.webp' },
      { name: 'Python', logo: '/assets/tools/python.webp' },
      { name: 'MYOB', logo: '/assets/tools/myob.webp' },
      { name: 'Zahir Accounting', logo: '/assets/tools/zahir.webp' },
      { name: 'Core Tax', logo: '/assets/tools/coretax.webp' }
    ],
    eduData: [
      { id: 1, institution: "State Islamic University Sunan Kalijaga Yogyakarta", degree: "Bachelor of Islamic Accounting", period: "Aug 2021 - Jun 2025", gpa: "3.74 / 4.00", logo: "/assets/logos/uin-logo.webp", details: ["Graduated with honors as the Highest & Most Accelerated Graduate of the Sharia Accounting Department.", "Authored an undergraduate thesis analyzing the correlation between ESG disclosures, board characteristics, and firm performance.", "Mastered computerized accounting systems and financial reporting standards to ensure high-accuracy data management."], courses: ["Cost Accounting", "Financial Accounting", "Tax Accounting", "Public Sector Accounting", "Information Systems Analysis and Design", "Financial Statement Analysis", "Economics", "Islamic Financial Management", "Risk Management", "Business and Economic Mathematics", "Auditing", "Taxation", "Accounting Information Systems", "Corporate Governance"] },
      { id: 2, institution: "Piranha Smart Center", degree: "Certificate in Tax Technician", period: "Jul 2023 - Sep 2023", gpa: "83.20 / 100.00", logo: "/assets/logos/psc-logo.webp", details: ["Completed intensive certification in Indonesian taxation covering PPh, VAT, tax planning, and General Tax Provisions (KUP).", "Executed hands-on simulations for the preparation and reporting of monthly and annual tax returns (SPT).", "Developed technical proficiency in tax calculations and compliance procedures according to national regulations."], courses: ["Tax Accounting", "Stamp Duty, Land and Building Tax (PBB), & Land and Building Rights Acquisition Duty (BPHTB)", "General Tax Provisions and Procedures", "Tax Planning", "Corporate Income Tax", "Individual Income Tax", "Withholding Income Tax", "Unified Income Tax", "VAT and Luxury Goods Sales Tax"] },
      { id: 'sma', institution: "MAN 3 Sleman", degree: "Senior High School Graduate", period: "Jul 2018 - May 2021", gpa: "85.43 / 100.00", logo: "/assets/logos/man3-logo.webp", details: ["Developed strong analytical and numerical skills through problem-solving and quantitative subjects.", "Active in student organizations, maintaining a balance between leadership roles and a strong academic record.", "Pursued the Natural Sciences (MIPA) curriculum with dedication to building a solid logical and disciplined foundation."], courses: ["English Language and Literature", "Indonesian Language", "Biology", "Economics", "Physics", "Informatics", "Chemistry", "Mathematics", "Islamic Religious Education"] }
    ],
    workData: [
      { id: 1, title: 'Tax Intern', company: 'PT Mitra Graha Integrasi', period: 'Nov 2025 - May 2026', location: 'Bogor City, ID', logo: "/assets/logos/migrasi-logo.webp", details: ["Managed precision withholding tax (PPh 21, 23, 4(2)) calculations and timely e-Faktur issuance.", "Successfully reconciled financial statements with specific tax objects to ensure error-free SPT filings.", "Architected a systematic archival system for tax documentation to mitigate administrative penalty risks."] },
      { id: 2, title: 'Tax Volunteer', company: 'Directorate General of Taxes', period: 'Feb 2024 - Dec 2024', location: 'Bantul, ID', logo: "/assets/logos/djp-logo.webp", details: ["Facilitated annual tax return (SPT) reporting for 40+ individual taxpayers through the e-Filing system.", "Provided technical guidance on EFIN activation and digital tax administration to enhance taxpayer compliance.", "Collaborated in community educational programs to increase public literacy on national tax obligations."] },
      { id: 3, title: 'System Analyst "My Tax"', company: 'Bangkit 2024 Batch 1 Capstone Project', period: 'Feb 2024 - Jul 2024', location: 'Sleman, ID', logo: "/assets/logos/tcuin-logo.webp", details: ["Translated complex taxation business needs into structured system requirements (PIECES, workflows) for app development.", "Collaborated with cross-functional teams to deliver a cloud-based solution for VAT calculations and reporting logic.", "Optimized system architecture for tax data accuracy, ensuring seamless integration between inputs and outputs."] },
      { id: 4, title: 'Tax Intern', company: 'Mitra Setara Digitax', period: 'Jan 2024 - Feb 2024', location: 'Yogyakarta City, ID', logo: "/assets/logos/msd-logo.webp", details: ["Spearheaded the migration of physical financial records to digital Excel bookkeeping, improving data accessibility.", "Processed and recorded over 200+ tax invoices using e-Faktur, maintaining consistency with monthly reporting aims.", "Mitigated reporting errors by conducting rigorous audits on 30+ prepopulated invoices against client ledger data."] }
    ],
    orgData: [
      { id: 1, title: 'Head of Community Service Division', company: 'Tax Center UIN Sunan Kalijaga', period: 'Sep 2023 - Sep 2024', location: 'Sleman, ID', logo: "/assets/logos/tcuin-logo.webp", details: ["Spearheaded the development of informative tax-related digital content, resulting in a 100+ follower increase on Instagram within a single term.", "Personally assisted 10+ individual taxpayers in accurately completing and filing their Annual Tax Returns (SPT).", "Coordinated community outreach programs to bridge the gap between complex tax regulations and public understanding."] },
      { id: 2, title: 'Coordinator of Interest & Talents Department', company: 'HMPS Akuntansi Syariah', period: 'Feb 2023 - Feb 2024', location: 'Sleman, ID', logo: "/assets/logos/hmpsaks-logo.webp", details: ["Facilitated specialized workshops and talent development programs for Islamic Accounting students through structured planning.", "Managed logistics and preparation support for students participating in regional and national accounting competitions.", "Collaborated with departmental faculty and interns to execute integrated work plans for student organization growth."] },
      { id: 3, title: 'Media & Documentation Staff (PDD)', company: '9th Febillionaire', period: 'Jul 2023 - Nov 2023', location: 'Sleman, ID', logo: "/assets/logos/9th-fbl-logo.webp", details: ["Managed high-impact event publication materials and documentation for one of the institution's largest annual festivals.", "Designed visual assets for various digital platforms to maintain a consistent and professional event branding strategy.", "Coordinated with cross-functional divisions to ensure seamless information flow and event coverage."] },
      { id: 4, title: 'Event Division Staff', company: '6th Sharia Accounting Fair', period: 'Jul 2023 - Oct 2023', location: 'Sleman, ID', logo: "/assets/logos/6th-saf-logo.webp", details: ["Organized a National Accounting Seminar, successfully managing logistics and guest speaker coordination for hundreds of participants.", "Supervised participant experience from registration to completion, ensuring the event met key institutional KPIs.", "Engineered a streamlined logistics flow for guest speakers and materials to maintain a punctual event schedule."] }
    ],
    projectsData: [
      { 
        id: 1, 
    ...
    certsCategories: [
      { 
        ...
        items: [
          { title: 'Tax Volunteer Award 2024 - Bronze', image: '/assets/certificates/appreciation-relawan-bronze.webp', link: '#' },
          { title: 'Bangkit Academy Contributor 2024', image: '/assets/certificates/appreciation-bangkit-2024.webp', link: '#' },
          { title: 'Tax Volunteer Award 2024 - Silver', image: '/assets/certificates/appreciation-relawan-silver.webp', link: '#' }
        ] 
      },
      { 
        id: 'completion', 
        ...
        items: [
          { title: 'Google AI Professional Certificates - Google', image: '/assets/certificates/completion-google-ai-professional.webp', link: '#' },
          { title: 'AI for Data Analysis - Google', image: '/assets/certificates/completion-google-ai-data.webp', link: '#' },
          { title: 'AI for Content Creation - Google', image: '/assets/certificates/completion-google-ai-content.webp', link: '#' },
          { title: 'AI for Writing and Communicating - Google', image: '/assets/certificates/completion-google-ai-writing.webp', link: '#' },
          { title: 'AI for Research and Insights - Google', image: '/assets/certificates/completion-google-ai-research.webp', link: '#' },
          { title: 'AI for Brainstorming and Planning - Google', image: '/assets/certificates/completion-google-ai-planning.webp', link: '#' },
          { title: 'Praktik Kerja Lapangan - Mitra Setara Digitax', image: '/assets/certificates/completion-msd-pkl.webp', link: '#' },
          { title: 'Introduction to Financial Literacy - Dicoding', image: '/assets/certificates/completion-dicoding-finance.webp', link: '#' },
          { title: 'Belajar Dasar SQL - Dicoding', image: '/assets/certificates/completion-dicoding-sql.webp', link: '#' },
          { title: 'Belajar Dasar Data Science - Dicoding', image: '/assets/certificates/completion-dicoding-ds.webp', link: '#' },
          { title: 'Introduction to Data Science with Python - DQLab', image: '/assets/certificates/completion-dqlab-ds-python.webp', link: '#' },
          { title: 'Python Fundamental for Data Science - DQLab', image: '/assets/certificates/completion-dqlab-python-fundamental.webp', link: '#' },
          { title: 'Belajar Dasar AI - Dicoding', image: '/assets/certificates/completion-dicoding-ai.webp', link: '#' },
          { title: 'Memulai Pemrograman dengan Python - Dicoding', image: '/assets/certificates/completion-dicoding-python.webp', link: '#' },
          { title: 'Belajar Machine Learning untuk Pemula - Dicoding', image: '/assets/certificates/completion-dicoding-ml.webp', link: '#' }
        ] 
      },
      { 
        id: 'committee', 
        ...
        items: [
          { title: 'Coordinator of Talents and Interest - HMPS AKS', image: '/assets/certificates/committee-hmps-koordinator.webp', link: '#' },
          { title: 'Event Division - 6th Sharia Accounting Fair', image: '/assets/certificates/committee-saf-6.webp', link: '#' },
          { title: 'Event Division - 5th Sharia Accounting Fair', image: '/assets/certificates/committee-saf-5.webp', link: '#' },
          { title: 'Committee Member - Language Fest 2023', image: '/assets/certificates/committee-langfest-2023.webp', link: '#' },
          { title: 'Committee Member - Language Fest 2022', image: '/assets/certificates/committee-langfest-2022.webp', link: '#' },
          { title: 'Equipment Division - Ramadhan Fest 1444H', image: '/assets/certificates/committee-ramadhan-fest.webp', link: '#' }
        ] 
      },
      { 
        id: 'competency', 
        ...
        items: [
          { title: 'Zahir User Certified', image: '/assets/certificates/competency-zahir-certified.webp', link: '#' },
          { title: 'Certified Tax Technician (CTT)', image: '/assets/certificates/competency-piranha-brevet.webp', link: '#' },
          { title: 'ICT Certification (TIK) - Excellent', image: '/assets/certificates/competency-tik.webp', link: '#' },
          { title: 'Test of English Competence (TOEC)', image: '/assets/certificates/competency-toec.webp', link: '#' },
          { title: 'Arabic Language Competence', image: '/assets/certificates/competency-arabic.webp', link: '#' },
          { title: 'Practicum: Basic Sharia Accounting', image: '/assets/certificates/competency-sharia-acc.webp', link: '#' },
          { title: 'Practicum: Manufacturing Accounting', image: '/assets/certificates/competency-manufacturing-acc.webp', link: '#' },
          { title: 'Practicum: Audit', image: '/assets/certificates/competency-audit.webp', link: '#' },
          { title: 'Practicum: Computer Accounting', image: '/assets/certificates/competency-computer-acc.webp', link: '#' },
          { title: 'Practicum: Sharia Financial Accounting', image: '/assets/certificates/competency-sharia-finance.webp', link: '#' },
          { title: 'Practicum: Intermediate Accounting', image: '/assets/certificates/competency-intermediate-acc.webp', link: '#' },
          { title: 'Practicum: Statistics', image: '/assets/certificates/competency-statistics.webp', link: '#' }
        ] 
      }
    ]
  },
  id: {
    ...
    certsCategories: [
      { 
        ...
        items: [
          { title: 'Relawan Pajak 2024 - Perunggu', image: '/assets/certificates/appreciation-relawan-bronze.webp', link: '#' },
          { title: 'Kontributor Bangkit Academy 2024', image: '/assets/certificates/appreciation-bangkit-2024.webp', link: '#' },
          { title: 'Relawan Pajak 2024 - Perak', image: '/assets/certificates/appreciation-relawan-silver.webp', link: '#' }
        ] 
      },
      { 
        id: 'completion', 
      ...
      { 
        ...
        items: [
          { title: 'Koordinator Minat dan Bakat - HMPS AKS', image: '/assets/certificates/committee-hmps-koordinator.webp', link: '#' },
          { title: 'Divisi Acara - 6th Sharia Accounting Fair', image: '/assets/certificates/committee-saf-6.webp', link: '#' },
          { title: 'Divisi Acara - 5th Sharia Accounting Fair', image: '/assets/certificates/committee-saf-5.webp', link: '#' },
          { title: 'Panitia Pelaksana - Language Fest 2023', image: '/assets/certificates/committee-langfest-2023.webp', link: '#' },
          { title: 'Panitia Pelaksana - Language Fest 2022', image: '/assets/certificates/committee-langfest-2022.webp', link: '#' },
          { title: 'Divisi Perlengkapan - Ramadhan Fest 1444H', image: '/assets/certificates/committee-ramadhan-fest.webp', link: '#' }
        ] 
      },
      { 
        id: 'competency', 
        ...
        items: [
          { title: 'Pengguna Zahir Bersertifikat', image: '/assets/certificates/competency-zahir-certified.webp', link: '#' },
          { title: 'Teknisi Pajak Bersertifikat - Piranha Smart Center', image: '/assets/certificates/competency-piranha-brevet.webp', link: '#' },
          { title: 'Sertifikasi TIK - Memuaskan', image: '/assets/certificates/competency-tik.webp', link: '#' },
          { title: 'Test of English Competence (TOEC)', image: '/assets/certificates/competency-toec.webp', link: '#' },
          { title: 'Tes Kompetensi Bahasa Arab', image: '/assets/certificates/competency-arabic.webp', link: '#' },
          { title: 'Praktikum Akuntansi Syariah', image: '/assets/certificates/competency-sharia-acc.webp', link: '#' },
          { title: 'Praktikum Akuntansi Manufaktur', image: '/assets/certificates/competency-manufacturing-acc.webp', link: '#' },
          { title: 'Praktikum Audit', image: '/assets/certificates/competency-audit.webp', link: '#' },
          { title: 'Praktikum Komputer Akuntansi', image: '/assets/certificates/competency-computer-acc.webp', link: '#' },
          { title: 'Praktikum Akuntansi Keuangan Syariah', image: '/assets/certificates/competency-sharia-finance.webp', link: '#' },
          { title: 'Praktikum Akuntansi Keuangan Menengah', image: '/assets/certificates/competency-intermediate-acc.webp', link: '#' },
          { title: 'Praktikum Statistik', image: '/assets/certificates/competency-statistics.webp', link: '#' }
        ] 
      }
    ]
  }
