        ...
        html: `
          ...
          <body>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #e6e7f0; padding: 40px 10px;">
              <tr>
                <td align="center">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 650px; background-color: #0f172a; border-radius: 28px; overflow: hidden; border: 0px solid #1e293b; box-shadow: 0 20px 50px rgba(255,255,255,1);">
                    
                    <!-- Header with Gradient and Logo -->
                    <tr>
                      <td align="center" style="padding: 50px 40px; background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 50%, #0ea5e9 100%);">
                        <img src="<img src="https://drive.google.com/uc?export=view&id=1mLqeBiZsKS6JyxWgrOM95YAU4gRnMbmv" alt="Portfolio Logo" width="180" style="display: block; margin-bottom: 24px; filter: drop-shadow(0 8px 12px rgba(0,0,0,0.2));">
                      ...
                      <td style="padding: 40px 30px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 20px;">
                          <tr>
                            ...
                            <td width="4%"></td>
                            <!-- Timestamp Column -->
                            <td width="48%" align="left" style="padding: 24px; background-color: rgba(30, 41, 59, 0.5); border-radius: 20px; border: 1px solid rgba(59, 130, 246, 0.1);">
